...
{
    public partial class EidtChildPage : PhoneApplicationPage
    {
        ...
        private void ParseResults(string results)
        {
            if (string.IsNullOrEmpty(results))
            {
                ...
                MessageBox.Show("Add child attempt was unsuccessful");
                return;
            }
            else
            {
                ...
                MessageBox.Show("Add child attempt was a " + results);
