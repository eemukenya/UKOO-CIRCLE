...
namespace Ukoo_Circle.user_details_views
{
    ...
    public partial class CousinsListPage : PhoneApplicationPage
    {
        ...
        private void ParseResults(string results)
        {
            if (string.IsNullOrEmpty(results))
            {
                ...
                MessageBox.Show("Fetching cousin(s) was unsuccessful...Try again");
                return;
            }
            else
            {
                ...
                {
                    List<Cousins> allrels = new List<Cousins>();
                    while (reader.Read())
                    {
