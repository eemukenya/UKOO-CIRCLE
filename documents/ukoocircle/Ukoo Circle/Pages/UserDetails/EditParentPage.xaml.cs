...
{
    public partial class EditParentPage : PhoneApplicationPage
    {
        ...
        private void ParseResults(string results)
        {
            if (string.IsNullOrEmpty(results))
            {
                ...
                MessageBox.Show("Add parent attempt was unsuccessful");
                return;
            }
            else if (results == "success")
            {
                ...
                MessageBox.Show("Add parent attempt was a" + results);
