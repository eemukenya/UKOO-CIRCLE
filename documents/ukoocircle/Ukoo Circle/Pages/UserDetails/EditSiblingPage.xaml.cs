...
{
    public partial class EditSiblingPage : PhoneApplicationPage
    {
        ...
        private void ParseResults(string results)
        {
            if (string.IsNullOrEmpty(results))
            {
                ...
                MessageBox.Show("Add sibling attempt was unsuccessful");
                return;
            }
            else if (results == "success")
            {
                ...
                MessageBox.Show("Add sibling attempt was a " + results);
