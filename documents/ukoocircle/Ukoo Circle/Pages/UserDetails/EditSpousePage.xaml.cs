...
{
    public partial class EditSpousePage : PhoneApplicationPage
    {
        ...
        private string xmlString = "<message>" +
                                   ...
                                   "search_item = 'value'/>" +
                                   "</message>";
        public EditSpousePage()
        {
            InitializeComponent();
            progressbar.Visibility = System.Windows.Visibility.Collapsed;
        }

        private void btnAddSpouse_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                string relative_relation_type = "3";
        ...
        private void ParseResults(string results)
        {
            if (string.IsNullOrEmpty(results))
            {
                ...
                MessageBox.Show("Add spouse attempt was unsuccessful");
                return;
            }
            else if (results == "success")
            {
                ...
                MessageBox.Show("Add spouse attempt was a " + results);
