...
namespace Ukoo_Circle.user_details_views
{
    ...
    public partial class SpouseListPage : PhoneApplicationPage
    {
        ...
        {
            NavigationService.Navigate(new Uri("/Pages/UserDetails/EditSpousePage.xaml", UriKind.Relative));
        }
    }
}